...
# 10 "D:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\c99\\math.h" 3
...
float calculate_resistance(int adc_channel) {
    return ( ((float) (10) * (1023 - adc_channel) / adc_channel));
}

int gas_plot_log_scale(float rs_ro_ratio, float *curve) {
    return powf(10,(((logf(rs_ro_ratio) - curve[1]) / curve[2]) + curve[0]));
}
